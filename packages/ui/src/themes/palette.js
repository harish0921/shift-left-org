...
export default function themePalette(theme) {
    return {
        ...
        primary: {
            light: theme.customization.isDarkMode ? '#60B8FF' : theme.colors?.primaryLight,
            main: theme.customization.isDarkMode ? '#2B9AF3' : theme.colors?.primaryMain,
            dark: theme.customization.isDarkMode ? '#0078D4' : theme.colors?.primaryDark,
            200: theme.customization.isDarkMode ? '#90CAF9' : theme.colors?.primary200,
        ...
        text: {
            primary: theme.customization.isDarkMode ? '#F1F5F9' : theme.darkTextPrimary,
            secondary: theme.customization.isDarkMode ? '#94A3B8' : theme.darkTextSecondary,
            dark: theme.textDark,
            hint: theme.colors?.grey100
        },
        background: {
            paper: theme.customization.isDarkMode ? '#1E293B' : theme.paper,
            default: theme.customization.isDarkMode ? '#0F172A' : theme.backgroundDefault
        },
        textBackground: {
