...
const ChatMessage = ({ open, chatflowid, isAgentCanvas, isDialog, previews, setPreviews }) => {
    ...
    useEffect(() => {
        ...
        } else if (open && !chatflowid) {
            // Unsaved flow: keep chat pane usable without blocking spinner.
            setIsConfigLoading(false)
        }
                    ...
                    >
                        ...
                        <Button
                            ...
                            sx={{
                                mb: 2,
                                borderRadius: 20,
                                background: 'linear-gradient(45deg, #E04F00 30%, #FF7A33 90%)'
                            }}
                        >
                                                        ...
                                                        >
                                                            {isTTSLoading[message.id] ? (
                                                                ...
                                                                <IconVolume
                                                                    ...
                                                                    color={customization.isDarkMode ? 'white' : '#FF7A33'}
                                                                />
                                                            )}
                                                        </IconButton>
                                                    )}
                            ...
                            >
                                ...
                                <div className='recording-control-buttons-container'>
                                    <IconButton onClick={onRecordingCancelled} size='small'>
                                        <IconX
                                            color={loading || !chatflowid ? '#9e9e9e' : customization.isDarkMode ? 'white' : '#FF7A33'}
                                        />
                                    </IconButton>
                                ...
                                <>
                                    {isChatFlowAvailableForImageUploads && !isChatFlowAvailableForFileUploads && (
                                        <InputAdornment position='start' sx={{ ml: 2 }}>
                                            ...
                                            >
                                                <IconPhotoPlus
                                                    color={getInputDisabled() ? '#9e9e9e' : customization.isDarkMode ? 'white' : '#FF7A33'}
                                                />
                                            </IconButton>
                                        </InputAdornment>
                                    )}
                                        ...
                                        <InputAdornment position='end' sx={{ paddingRight: '15px' }}>
                                            <IconButton type='submit' disabled={getInputDisabled()} edge='end'>
                                                {loading ? (
                                                    ...
                                                    <IconSend
                                                        color={
                                                            getInputDisabled() ? '#9e9e9e' : customization.isDarkMode ? 'white' : '#FF7A33'
                                                        }
                                                    />
                                                )}
                                            </IconButton>
